    ...
    : AbstractModule{owner, ModuleType::FL, "FL", "fl_on"}
{
    ...
    m_mix = new ControlValue(this, "fl_mx", "Mix", "", -63, 64, -63, 64);
    m_lfo = new ControlValue(this, "fl_lf", "LFO");
    m_rate = new ControlValue(this, "fl_rt", "Rate", "Hz",  0, 127, 0.024, 9.6); // Range: 0 (0.024 Hz) to 127 (9.6 Hz).
    m_width = new ControlValue(this, "fl_wd", "Width", "",  0, 127, 0, 127);
    m_delay = new ControlValue(this, "fl_dl", "Delay", "ms",  0, 127, 0, 21);
    m_feedback = new ControlValue(this, "fl_fb", "Feedback", "",  0, 127, 0, 21);
    m_hpf = new ControlValue(this, "fl_hp", "HPF", "Hz",  0, 127, 20, 2000);

}

void Flanger::setValues(uint8_t enabled, const flanger_fx_t &flData, uint8_t hpfValue)
{
